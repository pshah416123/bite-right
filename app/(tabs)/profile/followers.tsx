...
import { getMe, getFollowers, type UserSummary } from '~/src/api/users';
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>People who follow you</Text>
      </View>
      {loading ? (
        ...
        <View style={styles.centered}>
          ...
          <Text style={styles.emptySubtext}>Share your profile to get discovered</Text>
        </View>
      ) : (
        <FlatList
          data={list}
