...
// Re-declared inline so the existing styles below (s.scroll, s.grid, etc.)
// can keep referencing the layout constants. The shared ProfileEats module
// uses its own copies for its tile sizing.
const GRID_GAP = 12;
