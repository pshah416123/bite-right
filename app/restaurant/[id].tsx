...
export default function RestaurantScreen() {
  ...
  // Menu block — three possible states. The "What people order" chip
  // fallback was retired because it duplicated the Standout dishes row
  // higher on the page (same dish names shown twice on restaurants
  // without a parseable menu). Better to show "Menu coming soon" and
  // let Standout dishes carry the dish signal.
  //   1. menuLoading                              -> spinner
  //   2. filteredMenu present                     -> full menu
  //   3. no menu, detail still fetching reviews   -> spinner
  //   4. no menu                                  -> "Menu coming soon"
